...
@if (app()->getLocale() =='ar')
    ...
    <link rel="stylesheet" href="{{asset('assets/admin/rtl/dist/css/font-awesome-rtl.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/admin/rtl/dist/css/AdminLTE-rtl.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/admin/rtl/dist/css/bootstrap-rtl.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/admin/rtl/dist/css/rtl.css')}}">
